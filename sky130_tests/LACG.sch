...
N 1250 -380 1250 -240 { lab=#net10}
N 1250 -240 1290 -240 { lab=#net10}
...
N 3000 -1740 3250 -1740 { lab=#net11}
N 3390 -1720 3420 -1720 { lab=#net12}
N 3000 -1620 3040 -1620 { lab=#net11}
N 3000 -1740 3000 -1620 { lab=#net11}
N 2960 -1620 3000 -1620 { lab=#net11}
N 3010 -1600 3010 -1560 { lab=#net13}
N 3010 -1600 3040 -1600 { lab=#net13}
N 3030 -1440 3030 -1410 { lab=#net12}
N 3030 -1410 3390 -1410 { lab=#net12}
N 3390 -1720 3390 -1410 { lab=#net12}
...
.endc
"}
C {devices/launcher.sym} 130 -340 0 0 {name=h1
descr="sky130_models.tcl"
tclcommand="eval exec ~/xschem_sky130/scripts/sky130_models.tcl"}
C {devices/code.sym} 130 -490 0 0 {name=STDCELLS only_toplevel=false 
format="tcleval(@value )"
value="
[sky130_models]
"}
C {devices/code.sym} 470 -490 0 0 {spice_ignore=false
name=TT_MODELS
only_toplevel=true
format="tcleval(@value )"
value="
*.include \\\\$::SKYWATER_MODELS\\\\/models/sky130.lib.spice tt
