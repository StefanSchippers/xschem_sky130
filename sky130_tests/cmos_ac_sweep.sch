...
S {}
E {}
B 2 170 -980 880 -620 {flags=graph
y1=0.00027
y2=82
divy=4
...
linewidth_mult=4.0
dataset=0}
B 2 1200 -80 1337 -20 {flags=image
alpha=0.6
InvertOnExport=true
...
T {Example showing a dc sweep of AC gain vs Common mode bias and VCC} 30 -1050 0 0 0.8 0.8 {}
N 30 -310 30 -280 {
lab=VCC}
N 30 -310 60 -310 {
lab=VCC}
...
N 500 -510 500 -480 {
lab=VCC}
C {devices/lab_pin.sym} 750 -360 0 0 {name=p20 lab=0  net_name=true}
C {devices/lab_pin.sym} 30 -220 0 0 {name=p17 lab=0  net_name=true}
C {devices/title.sym} 160 -30 0 0 {name=l1 author="Stefan Schippers"  net_name=true}
C {devices/vsource.sym} 30 -250 0 0 {name=VVCC value=VDD  net_name=true}
C {devices/lab_pin.sym} 570 -100 0 0 {name=p1 lab=0  net_name=true}
C {devices/lab_pin.sym} 60 -310 0 1 {name=p2 lab=VCC  net_name=true}
C {devices/lab_pin.sym} 260 -100 0 0 {name=p3 lab=0  net_name=true}
C {devices/isource.sym} 260 -270 0 0 {name=IBIAS value=10u  net_name=true}
C {devices/lab_pin.sym} 260 -300 0 0 {name=p4 lab=0  net_name=true}
C {devices/lab_pin.sym} 520 -290 0 1 {name=p5 lab=0  net_name=true}
C {devices/lab_pin.sym} 670 -290 0 0 {name=p0 lab=0  net_name=true}
C {devices/lab_pin.sym} 570 -550 0 0 {name=p8 lab=VCC  net_name=true}
C {devices/lab_pin.sym} 440 -290 0 0 {name=p9 lab=PLUS  net_name=true}
C {devices/lab_pin.sym} 750 -290 0 1 {name=p10 lab=MINUS  net_name=true}
C {devices/lab_pin.sym} 830 -420 0 1 {name=p11 lab=DIFFOUT  net_name=true}
C {devices/lab_pin.sym} 260 -210 0 0 {name=p13 lab=GN  net_name=true}
C {devices/lab_pin.sym} 70 -520 0 1 {name=p15 lab=PLUS  net_name=true}
C {devices/lab_pin.sym} 70 -410 0 1 {name=p18 lab=MINUS  net_name=true}
C {devices/capa.sym} 750 -390 0 0 {name=CL
m=1
value=2p
footprint=1206
device="ceramic capacitor"  net_name=true}
C {devices/lab_pin.sym} 500 -430 0 0 {name=p12 lab=G  net_name=true}
...
C {devices/launcher.sym} 740 -110 0 0 {name=h2
descr="View raw file"
tclcommand="textwindow $netlist_dir/[file tail [file rootname [xschem get current_name]]].raw"}
C {devices/ngspice_probe.sym} 570 -260 0 0 {name=r3}
C {devices/launcher.sym} 315 -595 0 0 {name=h3 
...
C {devices/vsource.sym} 40 -460 0 0 {name=V3 value="dc 0 ac 1 0"  net_name=true}
C {devices/lab_pin.sym} 40 -350 0 0 {name=p19 lab=0  net_name=true}
C {devices/vsource.sym} 40 -380 0 0 {name=V2 value=VCM  net_name=true}
...
.control
  ...
  ** vectors in plot \\"const\\" are globally available without const. prefix
  let npoints = 30
  set curplot = new
  set myplot = $curplot
  let gain = vector(npoints + 1)
  let cm = vector(npoints + 1)
  ...
  while vddval <= 2.01
    ...
    while v <= endv + stepv / 2
      ...
      ac dec 1 1k 10k
      remzerovec
      let \{$myplot\}.gain[\{$&i\}] = mag(v(DIFFOUT)[0])
      let \{$myplot\}.cm[\{$&i\}] = v
      let v = v + stepv
      let i = i + 1
    end
    ...
    setscale cm
    settype voltage cm
    settype voltage gain
    setcs curplottitle = \\"GAIN vs common mode\\"
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 520 -480 0 1 {name=M2
L=2
W=5
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 480 -290 0 0 {name=M6
L=0.5
W=2
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 710 -290 0 1 {name=M4
L=0.5
W=2
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 550 -160 0 0 {name=M1
L=2
W=4
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 280 -160 0 1 {name=M3
L=2
W=4
nf=1 
mult=1
...
C {devices/code.sym} 20 -850 0 0 {name=TT_MODELS
only_toplevel=true
...
"
spice_ignore=false}
C {devices/ammeter.sym} 570 -220 0 1 {name=Vtail}
C {devices/ammeter.sym} 500 -370 0 1 {name=Vleft}
C {devices/ngspice_get_value.sym} 410 -470 0 1 {name=r1 node=i(@m.$\{path\}xm2.msky130_fd_pr__pfet_01v8_lvt[id])
descr="Id="}
C {devices/ngspice_get_value.sym} 780 -470 0 0 {name=r2 node=i(@m.$\{path\}xm7.msky130_fd_pr__pfet_01v8_lvt[id])
descr="Id="}
