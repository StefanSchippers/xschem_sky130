...
T {Example showing a dc sweep of AC gain vs Common mode bias and VCC} 30 -1080 0 0 0.8 0.8 {}
N 30 -310 30 -280 {
lab=VCC}
N 30 -310 60 -310 {
lab=VCC}
...
C {devices/lab_pin.sym} 570 -70 0 0 {name=p1 lab=0  }
C {devices/lab_pin.sym} 60 -310 0 1 {name=p2 lab=VCC  }
C {devices/lab_pin.sym} 260 -70 0 0 {name=p3 lab=0  }
C {devices/isource.sym} 260 -270 0 0 {name=IBIAS value=10u  }
C {devices/lab_pin.sym} 260 -300 0 0 {name=p4 lab=0  }
C {devices/lab_pin.sym} 520 -290 0 1 {name=p5 lab=0  }
C {devices/lab_pin.sym} 670 -290 0 0 {name=p0 lab=0  }
C {devices/lab_pin.sym} 570 -550 0 0 {name=p8 lab=VCC  }
C {devices/lab_pin.sym} 440 -290 0 0 {name=p9 lab=PLUS  }
C {devices/lab_pin.sym} 750 -290 0 1 {name=p10 lab=MINUS  }
C {devices/lab_pin.sym} 830 -420 0 1 {name=p11 lab=DIFFOUT  }
C {devices/lab_pin.sym} 260 -180 0 0 {name=p13 lab=GN  }
C {devices/lab_pin.sym} 70 -520 0 1 {name=p15 lab=PLUS  }
C {devices/lab_pin.sym} 70 -410 0 1 {name=p18 lab=MINUS  }
C {devices/capa.sym} 750 -390 0 0 {name=CL
m=1
value=2p
footprint=1206
device="ceramic capacitor"  }
C {devices/lab_pin.sym} 500 -430 0 0 {name=p12 lab=G  }
C {devices/launcher.sym} 710 -110 0 0 {name=h1
descr=Backannotate
tclcommand="xschem annotate_op $netlist_dir/[file tail [file rootname [xschem get current_name]]].raw"
}
C {devices/launcher.sym} 710 -80 0 0 {name=h2
descr="View raw file"
...
C {devices/code_shown.sym} 930 -990 0 0 {name=COMMANDS
only_toplevel=true
value=".param VCM = 1 VDD=1.8
.option savecurrents
.include cmos_ac_sweep.save
.control
  save all
  op
...
C {sky130_fd_pr/nfet_01v8.sym} 550 -130 0 0 {name=M1
L=2
W=4
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 280 -130 0 1 {name=M3
L=2
W=4
nf=1 
mult=1
...
C {sky130_fd_pr/annotate_fet_params.sym} 410 -550 0 1 {name=annot1 ref=M2}
C {sky130_fd_pr/annotate_fet_params.sym} 780 -550 0 0 {name=annot2 ref=M7}
C {sky130_fd_pr/annotate_fet_params.sym} 440 -260 0 1 {name=annot3 ref=M6}
C {sky130_fd_pr/annotate_fet_params.sym} 770 -260 0 0 {name=annot4 ref=M4}
