...
N 690 -130 710 -130 {lab=B}
N 630 -130 650 -130 {lab=G1v8}
N 690 -190 690 -170 {lab=#net1}
N 690 -90 690 -70 {lab=S}
N 640 -270 2400 -270 { lab=D1v8}
N 1190 -130 1210 -130 {lab=B}
N 1130 -130 1150 -130 {lab=G3v3}
N 1190 -190 1190 -170 {lab=#net2}
N 1190 -90 1190 -70 {lab=S}
N 940 -130 960 -130 {lab=B}
N 880 -130 900 -130 {lab=G1v8}
N 940 -190 940 -170 {lab=#net3}
N 940 -90 940 -70 {lab=S}
N 1440 -130 1460 -130 {lab=B}
N 1380 -130 1400 -130 {lab=G5v0}
N 1440 -190 1440 -170 {lab=#net4}
N 1440 -90 1440 -70 {lab=S}
...
C {devices/lab_pin.sym} 690 -70 0 1 {name=p3 lab=S}
C {devices/lab_pin.sym} 710 -130 0 1 {name=p4 lab=B}
C {devices/ammeter.sym} 690 -220 0 0 {name=Vd1}
C {devices/lab_pin.sym} 1190 -70 0 1 {name=p12 lab=S}
C {devices/lab_pin.sym} 1210 -130 0 1 {name=p13 lab=B}
C {devices/ammeter.sym} 1190 -220 0 0 {name=Vd3}
C {sky130_fd_pr/nfet_01v8_lvt.sym} 670 -130 0 0 {name=M1
L=0.15
W=1
nf=1 mult=1
model=nfet_01v8_lvt
...
C {sky130_fd_pr/nfet_01v8.sym} 920 -130 0 0 {name=M2
L=0.15
W=1  
nf=1 mult=1
model=nfet_01v8
...
C {devices/lab_pin.sym} 940 -70 0 1 {name=p16 lab=S}
C {devices/lab_pin.sym} 960 -130 0 1 {name=p21 lab=B}
C {devices/ammeter.sym} 940 -220 0 0 {name=Vd2}
C {sky130_fd_pr/nfet_03v3_nvt.sym} 1170 -130 0 0 {name=M3
L=0.5
W=1
...
C {devices/lab_pin.sym} 1440 -70 0 1 {name=p7 lab=S}
C {devices/lab_pin.sym} 1460 -130 0 1 {name=p8 lab=B}
C {devices/ammeter.sym} 1440 -220 0 0 {name=Vd4}
C {sky130_fd_pr/nfet_05v0_nvt.sym} 1420 -130 0 0 {name=M4
L=0.9
W=1
ad="'W * 0.29'" pd="'W + 2 * 0.29'"
as="'W * 0.29'" ps="'W + 2 * 0.29'"
...
C {devices/lab_pin.sym} 630 -130 0 0 {name=p2 lab=G1v8}
C {devices/lab_pin.sym} 880 -130 0 0 {name=p6 lab=G1v8}
C {devices/lab_pin.sym} 1130 -130 0 0 {name=p11 lab=G3v3}
C {devices/lab_pin.sym} 1380 -130 0 0 {name=p15 lab=G5v0}
C {devices/lab_pin.sym} 1690 -70 0 1 {name=p1 lab=S}
C {devices/lab_pin.sym} 1710 -130 0 1 {name=p5 lab=B}
C {devices/ammeter.sym} 1690 -220 0 0 {name=Vd5}
C {devices/lab_pin.sym} 1630 -130 0 0 {name=p10 lab=G5v0}
...
C {sky130_fd_pr/nfet_g5v0d10v5.sym} 1670 -130 0 0 {name=M5
L=0.5
W=1
ad="'W * 0.29'" pd="'W + 2 * 0.29'"
as="'W * 0.29'" ps="'W + 2 * 0.29'"
...
C {devices/lab_pin.sym} 1940 -70 0 1 {name=p1 lab=S}
C {devices/lab_pin.sym} 1960 -130 0 1 {name=p5 lab=B}
C {devices/lab_pin.sym} 1880 -130 0 0 {name=p10 lab=G5v0}
...
C {sky130_fd_pr/nfet_g5v0d16v0.sym} 1920 -130 0 0 {name=M6
L=0.7
W=5.0
ad="'W * 0.29'" pd="'W + 2 * 0.29'"
as="'W * 0.29'" ps="'W + 2 * 0.29'"
...
C {devices/lab_pin.sym} 2190 -70 0 1 {name=p40 lab=S}
C {devices/lab_pin.sym} 2210 -130 0 1 {name=p41 lab=B}
C {devices/lab_pin.sym} 2130 -130 0 0 {name=p42 lab=G5v0}
C {devices/ammeter.sym} 2190 -220 0 0 {name=Vd7}
C {sky130_fd_pr/nfet_20v0.sym} 2170 -130 0 0 {name=M7
L=0.5
W=20.0
ad="'W * 0.29'" pd="'W + 2 * 0.29'"
as="'W * 0.29'" ps="'W + 2 * 0.29'"
