...
C {devices/lab_pin.sym} 2330 -1980 0 0 {name=l13 sig_type=std_logic lab=BNEXT[1]}
...
C {sky130_stdcells/nand2_1.sym} 2420 -1960 0 0 {name=x3 VGND=VGND VNB=VNB VPB=VPB VPWR=VPWR prefix=sky130_fd_sc_hd__ }
