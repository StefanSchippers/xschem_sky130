...
divx=10}
T {32 and 256 bit adders: Carry Look Ahead vs Ripple Carry.} 60 -870 0 0 1 1 {}
T {Global
...
C {devices/lab_pin.sym} 460 -250 0 0 {name=p3 lab=B[255:0]}
C {devices/lab_pin.sym} 1040 -250 0 1 {name=p5 lab=COUT3}
C {devices/lab_pin.sym} 760 -230 0 1 {name=p6 lab=SG3}
C {devices/lab_pin.sym} 460 -230 0 0 {name=p7 lab=CIN}
...
C {devices/spice_probe.sym} 650 -350 0 0 {name=p19 attrs=""}
...
C {devices/lab_pin.sym} 920 -140 0 1 {name=p27 lab=S2[31:0]}
C {devices/lab_pin.sym} 1040 -120 0 1 {name=p28 lab=COUT2}
C {devices/lab_pin.sym} 760 -100 0 1 {name=p29 lab=SG2}
C {devices/lab_pin.sym} 760 -80 0 1 {name=p30 lab=SP2}
C {devices/spice_probe.sym} 1040 -120 0 0 {name=p31 attrs=""}
...
C {devices/spice_probe.sym} 1110 -430 0 0 {name=p37 attrs=""}
C {devices/spice_probe.sym} 1110 -350 0 0 {name=p38 attrs=""}
C {devices/spice_probe.sym} 920 -140 0 0 {name=p39 attrs=""}
C {devices/parax_cap.sym} 870 -280 2 0 {name=C2[255:0] gnd=0 value=5f m=1}
...
C {devices/parax_cap.sym} 1110 -420 0 0 {name=C5[31:0] gnd=0 value=5f m=1}
...
xschem set netlist_name test_carry_lookahead_ngspice.spice
xschem netlist
xschem simulate
#set Xyce batch run
set sim(spice,default) 2 ;# 3rd simulator: Xyce
set sim(spice,2,st) 1 ;# status reporting
xschem set netlist_name test_carry_lookahead_xyce.spice
xschem netlist
xschem simulate
